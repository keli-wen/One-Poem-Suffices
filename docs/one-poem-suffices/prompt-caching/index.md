![prompt-caching-header](./assets/prompt-caching-header.webp)
...
!!! question "为什么 caching 是通过前缀匹配识别？必须使用前缀匹配吗？"
...
![prefix-matching-limitation](./assets/prefix-matching-limitation.png)
...
![pml-example](./assets/pml-example.png)
