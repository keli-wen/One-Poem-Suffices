...
![fig1-harness-filesystem](./assets/fig1-harness-filesystem.png)
...
!!! quote "OpenAI — [Harness engineering](https://openai.com/index/harness-engineering/)"
    ...
    *Enforcing architecture and taste* — 贯彻架构与品味，智能体在具有严格边界和可预测结构的环境中效率最高。
...
![fig2-fanout-convergence](./assets/fig2-fanout-convergence.png)

### Phase 0：搭脚手架

在任何 Agent 动手之前，我先和 Codex 对齐了项目范围和命名，然后让它生成了 §1 中的全套 harness 文件。我给的 prompt 大意是：

!!! example "给 Codex 的 Prompt"
...
- [Context Engineering，一篇就够了](../../one-poem-suffices/context-engineering/) — 基向量之一
- [Just-in-Time Context，一篇就够了](../../one-poem-suffices/just-in-time-context/) — 基向量之二
- [Thinking in Context: Codex 中的上下文工程](../../thinking-in-context/context-engineering-from-codex/) — 基向量之三
- [Anthropic: Effective harnesses for long-running agents](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents)
